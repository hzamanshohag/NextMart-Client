...
const CreateShopForm = () => {
  ...
  return (
    <div className="border-2 border-gray-300 rounded-xl flex-grow max-w-2xl p-5 my-5 bg-white shadow-md">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 mt-2 md:mt-4">
            <FormField
